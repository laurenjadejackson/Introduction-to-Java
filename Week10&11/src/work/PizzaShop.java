...
public class PizzaShop {
	...
	// the pizza database - all pizzas that can be ordered
		...
		public PizzaShop() {
			...
			Pizza pizza2 = new Pizza("hawain", new String[] { "cheese", "tomato", "ham", "pineapple" }, 6.50);
			...
			InternetCustomer icustomer1 = new InternetCustomer("Teresa Ingram", "1 ParkWay", "T@hotmail.com");
			InternetCustomer icustomer2 = new InternetCustomer("Lauren Jackson", "11 Eden Avenue", "Loz@icloud.com");
			InternetCustomer icustomer3 = new InternetCustomer("Tom Dale", "3 Cledford Street", "TomDale@gmail.com");
			// create a new array from the customers we have just created
			customers = new Customer[] { customer1, customer2, customer3, icustomer1, icustomer2, icustomer3 };
